...
const TRANSLATION_ES = {
    ...
    network: 'Red',
    session: 'Sesión',
    extdetail: 'Detalles de la extensión',
    maxresolution: 'Resolución máxima',
    fps: 'FPS',
    testdiscl: '<b>Advertencia:</b> Este juego aún no se ha probado.',
    datadiscl: 'Esta es la velocidad máxima de fotogramas que se logra al jugar en modo 4K (requiere Stadia Pro). \
                En los juegos con interruptor de resolución/rendimiento, se eligió la resolución. \
    ...
    notificationdesc: 'Muestra una notificación cuando Stadia Enhanced se actualiza a una nueva versión ("Auto" se oculta después de 5 segundos, "Manual" permanece hasta la interacción del usuario)',
